...
import com.book.mymovie.entity.*;
import com.book.mymovie.exception.AuditoriumNotFoundException;
...
import com.book.mymovie.model.TicketDetails;
import com.book.mymovie.model.UserRole;
import com.book.mymovie.repository.*;
...
public class TheatreController {
    ...
    private final TheatreRepository auditorium;

    @GetMapping({"/", "all"})
    public List<TheatreEntity> findAllAuditoriums() {
        return this.auditorium.findAll();
    }

    @GetMapping("{auditorium_id}")
    public TheatreEntity findAuditoriumById(@PathVariable final int auditorium_id) {
    ...
    @PostMapping("add")
    public TheatreEntity saveAuditorium(@RequestBody final TheatreEntity auditorium) {
        return this.auditorium.save(auditorium);
    }

    @PutMapping("update")
    public TheatreEntity updateAuditorium(@RequestBody final TheatreEntity auditorium) {
        return this.auditorium.save(auditorium);
    }
    ...
    public ShowEntity saveShow(@PathVariable final int auditorium_id,
        ...
        final TheatreEntity auditorium = this.findAuditoriumById(auditorium_id);
        show.setTheatre(auditorium);
    ...
    public List<TheatreEntity> findAuditoriumsByMovieId(@PathVariable final int movieId) {
...
//        booking.setUserId(this.service.findByMobile("8099531318").get().getId());
    ...
    public TicketDetails getMovieDetails(@PathVariable final int booking_id) {
        ...
        final TheatreEntity auditorium = this.auditorium.findAll().stream().filter(hall -> hall.getShows()
