...
public class MovieEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Objects.equals(name, that.name) && Objects.equals(image, that.image) && Objects.equals(bgImage, that.bgImage) && Objects.equals(story, that.story) && Objects.equals(year, that.year) && Objects.equals(duration, that.duration) && Objects.equals(caption, that.caption) && Objects.equals(addedOn, that.addedOn) && Objects.equals(release, that.release) && Objects.equals(language, that.language) && Objects.equals(genres, that.genres) && Objects.equals(casts, that.casts) && Objects.equals(crews, that.crews);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, image, bgImage, story, year, duration, caption, addedOn, release, language, genres, casts, crews);
    }
