package com.book.mymovie.entity;
...
//            inverseJoinColumns = @JoinColumn(name = "show_id", unique = false))
    ...
    public TheatreEntity(String name, String image, String email, String customerCareNo, String address,
    ...
    public TheatreEntity setId(int id) {
        this.id = id;
        return this;
    }

    public TheatreEntity setName(String name) {
        this.name = name;
        return this;
    }

    public TheatreEntity setImage(String image) {
        this.image = image;
        return this;
    }

    public TheatreEntity setEmail(String email) {
        this.email = email;
        return this;
    }

    public TheatreEntity setCustomerCare(String customerCareNo) {
        this.customerCareNo = customerCareNo;
        return this;
    }

    public TheatreEntity setAddress(String address) {
        this.address = address;
        return this;
    }

    public TheatreEntity setSeatCapacity(int seatCapacity) {
        this.seatCapacity = seatCapacity;
        return this;
    }

    public TheatreEntity setFacilities(List<String> facilities) {
        this.facilities = facilities;
        return this;
    }

    public TheatreEntity setSafeties(List<String> safeties) {
        this.safeties = safeties;
        return this;
    }

    public TheatreEntity setShows(List<ShowEntity> shows) {
        this.shows = shows;
        return this;
    }
}